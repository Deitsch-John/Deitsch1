#' Produces sf dataframe with range polygons for two species
#'
...
TwoSpecies_df <- function(dataframe, species_col, species1, species2,
...
#' Produces range map for two species
#'
...
TwoSpecies_map <- function(dataframe, background_map, greatlakes_map, crs_map,
